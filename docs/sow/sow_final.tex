    ...
    \section{Tasks}
        ...
        implementation.
            ...
            boards and their corresponding best practices.
                ...
                %  What are designs that are commonly used, such as common
                % arithmetic operations that will be helpful in the design of our
                % system? What is and isn't allowed in VHDL in order for it to be
                % synthesizable? What are some important specifications to look
                % at when shopping for an FPGA? What are specifications do we
                % need of our FPGA to meet our requirements?
                ...
                % communicate with these devices? What specifications are
                % required of these devices to meet our system requirements?
        ...
        \subsection{Software Implementation}
            ...
            %All simulations and
            %software testing are expected to be completed by the end of
            %December.

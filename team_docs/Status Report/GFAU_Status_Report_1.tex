...
\begin{document}
    ...
    \documentinfo{\textbf{MEMO:} TSR-01}{\textbf{DATE: }{October 6, 2017}}{\textbf{TO: } EFC LaBerge}{\textbf{FROM: }\Sabbir, \Jeffrey, \Howard, \Brian}{\textbf{SUBJECT: } Team Status Report}
    ...
    \section{WORK EXPECTED DURING NEXT PERIOD}
